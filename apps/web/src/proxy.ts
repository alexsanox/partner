...
function addSecurityHeaders(res: NextResponse): NextResponse {
  ...
  res.headers.set(
    ...
    [
      ...
      "font-src 'self' data:",
      "connect-src 'self' https://challenges.cloudflare.com https://api.resend.com https://cdn.jsdelivr.net https://api.stripe.com https://api.modrinth.com https://*.r2.cloudflarestorage.com https://cdn.novally.tech",
