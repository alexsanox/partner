...
function addSecurityHeaders(res: NextResponse): NextResponse {
  ...
  res.headers.set(
    ...
    [
      ...
      "font-src 'self' data:",
      "connect-src 'self' https://challenges.cloudflare.com https://api.resend.com https://cdn.jsdelivr.net https://api.stripe.com https://api.modrinth.com https://*.t3.storage.dev https://t3.storage.dev",
