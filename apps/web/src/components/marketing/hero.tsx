    ...
    <section className="relative overflow-hidden bg-[#0d1117]">
      ...
      <div className="mx-auto max-w-7xl px-4 pb-20 pt-24 sm:px-6 sm:pb-28 sm:pt-32 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          {/* Badge */}
          <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-[#00c98d]/30 bg-[#00c98d]/10 px-4 py-1.5">
          ...
          <h1 className="text-5xl font-black tracking-tight text-white sm:text-6xl lg:text-[80px] lg:leading-[1.05]">
            MINECRAFT
            <br />
          ...
          <p className="mx-auto mt-7 max-w-2xl text-lg leading-relaxed text-[#a8b0c4] sm:text-xl">
          ...
          <div className="mt-16 grid grid-cols-2 gap-3 sm:grid-cols-4">
            {[
              ...
              <div
                key={stat.label}
                className="flex flex-col items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.04] p-4"
              >
